package se233.chapter6_ch2.controller;
...
import se233.chapter6_ch2.Launcher;
import se233.chapter6_ch2.model.Currency;
import se233.chapter6_ch2.model.CurrencyEntity;
    ...
    public static void onDelete(String code){
        try{
            ...
            if(index!=-1){
                ...
                Launcher.setCurrencyList(currencyList);
                Launcher.refreshPane();
                logger.info("Removed Currency: {}",code);
            }
        }catch (InterruptedException e){
            e.printStackTrace();
        }catch (ExecutionException e){
