...
import se233.chapter6_ch5_p1.model.GameCharacter;
import se233.chapter6_ch5_p1.model.Keys;
...
//        assertTrue(yVelocityField.getInt(gameCharacter)>0,"yVelocity should be should be greater than 0 while falling");
    }
